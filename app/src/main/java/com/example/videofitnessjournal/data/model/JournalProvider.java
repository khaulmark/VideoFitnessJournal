package com.example.videofitnessjournal.data.model;
...
public class JournalProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.videofitnessjournal.data.model.JournalProvider";
    ...
    public static final String JOURNAL_TABLE_COL_USERNAME = "TITLE";
    public static final String JOURNAL_TABLE_COL_PASSWORD = "PASSWORD";
    ...
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            ...
            JOURNAL_TABLE_COL_PASSWORD + " TEXT)";
